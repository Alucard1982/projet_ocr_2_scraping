...
def data_display_book(list_name_dic_book_by_categorie):
    ...
    for name, list_dic_book in list_name_dic_book_by_categorie:
        path = "C:\\Users\\marie\\PycharmProjects\\projetOcr2\\data\\" + name
        os.makedirs(path, exist_ok=True)
        os.makedirs(path + "\\img", exist_ok=True)
        file = open(path + "/description_book_" + name + ".csv", 'w', encoding='utf-8')
